  ...
  return (
    <header>
      <div className="user-profile">
        ...
        <Link to="/judge-profile">Profile</Link>
      </div>
...
function CaseSchedule() {
  ...
  const cases = [
    { id: 1, name: 'Case 1', number: '12345', time: '9:00 AM', location: 'Courtroom 1', status: 'pending'},
    { id: 2, name: 'Case 2', number: '67890', time: '10:30 AM', location: 'Courtroom 2', status: 'solved'},
        ...
        <tbody>
          {cases.map((caseItem, index) => (
            <tr key={index}>
              ...
              <td>             
              <button type="button">Add Hiring</button>
              </td>
              <td>
              <button type="button">Case Solved</button>
              </td>
            </tr>
          ))}
        </tbody>
